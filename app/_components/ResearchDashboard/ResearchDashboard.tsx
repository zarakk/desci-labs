import { addFile, publishDraft, setDraft, setTitle } from "@/lib/researchSlice";
...
const ResearchDashboard = () => {
  ...
  const handlePublish = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => setPublishStatus("Publish"), 2000);
    }, 2000);
  };

  return (
    <div className="p-4 flex gap-4 pl-0">
      <div
        className={`${
      ...
      >
        <>
          ...
          <button
            className="p-2 border border-white w-full mt-4"
      ...
      <div className="w-full">
        ...
        <div className="bg-[#4f4f4f] p-2">
          <input
            type="text"
            className="text-[#fbfbfd] bg-transparent w-full outline-none"
        ...
        <div className="">
          <h3 className="text-[#777b84] my-4">Draft</h3>
          <textarea
            className="text-white bg-[#4f4f4f] w-full p-2"
            rows={8}
